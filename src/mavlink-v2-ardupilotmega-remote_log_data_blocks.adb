...
package body MAVLink.V2.Ardupilotmega.Remote_Log_Data_Blocks is
   ...
   begin
      Last := Buffer'First +
        ...
        (Remote_Log_Data_Block'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Remote_Log_Data_Block_Id, 159, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Remote_Log_Data_Block'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
