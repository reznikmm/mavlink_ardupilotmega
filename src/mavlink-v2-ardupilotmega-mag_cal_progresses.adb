...
package body MAVLink.V2.Ardupilotmega.Mag_Cal_Progresses is
   ...
   begin
      Last := Buffer'First +
        ...
        (Mag_Cal_Progress'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Mag_Cal_Progress_Id, 92, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Mag_Cal_Progress'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
