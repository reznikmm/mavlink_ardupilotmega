...
package MAVLink.V1.Ardupilotmega.Digicam_Configures is

   pragma Pure;

   Digicam_Configure_Len : constant Interfaces.Unsigned_8 := 15;
...
end MAVLink.V1.Ardupilotmega.Digicam_Configures;
