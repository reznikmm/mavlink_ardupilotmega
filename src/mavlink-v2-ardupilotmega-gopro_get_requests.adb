...
package body MAVLink.V2.Ardupilotmega.Gopro_Get_Requests is
   ...
   begin
      Last := Buffer'First +
        ...
        (Gopro_Get_Request'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Gopro_Get_Request_Id, 50, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Gopro_Get_Request'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Ardupilotmega.Gopro_Get_Requests;
