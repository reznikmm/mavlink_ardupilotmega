...
package body MAVLink.V2.Ardupilotmega.Fence_Fetch_Points is
   ...
   begin
      Last := Buffer'First +
        ...
        (Fence_Fetch_Point'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Fence_Fetch_Point_Id, 68, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Fence_Fetch_Point'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
