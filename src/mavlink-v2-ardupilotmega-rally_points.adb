...
package body MAVLink.V2.Ardupilotmega.Rally_Points is
   ...
   begin
      Last := Buffer'First +
        ...
        (Rally_Point'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Rally_Point_Id, 138, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Rally_Point'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Ardupilotmega.Rally_Points;
