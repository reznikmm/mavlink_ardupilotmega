...
package body MAVLink.V2.Ardupilotmega.Digicam_Configures is
   ...
   begin
      Last := Buffer'First +
        ...
        (Digicam_Configure'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Digicam_Configure_Id, 84, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Digicam_Configure'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
