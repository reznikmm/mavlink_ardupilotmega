...
package body MAVLink.V2.Ardupilotmega.Camera_Statuses is
   ...
   begin
      Last := Buffer'First +
        ...
        (Camera_Status'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Camera_Status_Id, 189, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Camera_Status'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
