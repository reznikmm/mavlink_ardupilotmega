...
package body MAVLink.V1.Ardupilotmega.Gopro_Set_Responses is
   ...
   is
      Buf : Data_Buffer (1 .. Gopro_Set_Response'Size / 8)
        with Import,
...
end MAVLink.V1.Ardupilotmega.Gopro_Set_Responses;
