...
package body MAVLink.V2.Ardupilotmega.Remote_Log_Block_Statuses is
   ...
   begin
      Last := Buffer'First +
        ...
        (Remote_Log_Block_Status'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Remote_Log_Block_Status_Id, 186, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Remote_Log_Block_Status'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Ardupilotmega.Remote_Log_Block_Statuses;
